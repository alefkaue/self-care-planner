    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-5">
      ...
      >
        ...
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-foreground">Your Best Self</h1>
        ...
        {mode !== "forgot" && (
          <div className="space-y-3">
            <Button
              variant="outline"
              className="w-full h-12 bg-secondary border-border text-foreground"
        ...
        <form onSubmit={handleEmailAuth} className="space-y-3">
          ...
          >
            {loading ? "Aguarde..." : mode === "signin" ? "Entrar" : mode === "signup" ? "Criar Conta" : "Enviar Email"}
